...
/// <summary>
/// 技能循环触发器
/// 实现 ITaskTrigger 接口，集成到新的任务系统中
/// 支持瞬发、正读条、引导三种施法类型
/// 需求: 14.1, 14.6 - 技能引擎作为 ITaskTrigger 实现
/// </summary>
public class SkillLoopTrigger : ITaskTrigger, IDisposable
{
    #region 依赖组件
    ...
    public SkillLoopTrigger(IKeyboardInterface keyboard, IImageInterface image, ConfigManager config)
    {
        _keyboard = keyboard;
        _image = image;
        _config = config;
